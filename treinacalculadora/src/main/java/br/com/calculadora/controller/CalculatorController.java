...
import br.com.calculadora.exception.PasswordException;
...
public class CalculatorController {
    ...
    public ResponseEntity<Double> adicao(@RequestParam("num1") Double num1, @RequestParam("num2") Double num2, @RequestParam(value = "senha", required = false) String senha) {
